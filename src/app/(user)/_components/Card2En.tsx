  ...
  const cards = [
    {
      ...
      description:
        "French-recognized degrees from Bac+2 to Bac+5 in Civil Engineering and Construction.",
    },
    {
      id: 2,
      ...
      description:
        "100% online, in-person, or via RPL – study at your own pace.",
    },
    {
      id: 3,
      icon: <Award className="text-4xl mb-4 w-12 h-10" />,
      title: "Recognition of Experience",
      description:
        "Leverage your professional experience through RPL to earn your diploma.",
    },
  ];
