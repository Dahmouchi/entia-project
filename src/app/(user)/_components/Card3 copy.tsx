...
const levels: Level[] = [
   {
    ...
    subjects: [
      { name: "Génie Civil", color: "bg-purple-400" },
      { name: "BTP", color: "bg-blue-400" },
      { name: "Dessin Technique", color: "bg-green-400" },
      { name: "Gestion de Projet", color: "bg-amber-400" },
      { name: "Topographie", color: "bg-indigo-400" },
    ],
  },
  {
    name: "Bac+3 (Licence)",
    grades: ["L3"],
    subjects: [
      { name: "Génie Civil et Construction", color: "bg-purple-400" },
      { name: "Chargé d'Affaires BTP", color: "bg-blue-400" },
      { name: "Management de Projet", color: "bg-teal-400" },
      { name: "Études Techniques", color: "bg-indigo-400" },
      { name: "Droit du BTP", color: "bg-red-400" },
      { name: "Économie de la Construction", color: "bg-amber-400" },
    ],
  },
  {
    name: "Bac+4/5 (Master)",
    grades: ["M1", "M2"],
    subjects: [
      { name: "Génie Civil et Travaux Publics", color: "bg-purple-400" },
      { name: "Management de Projets BTP", color: "bg-blue-400" },
      { name: "Ingénierie des Structures", color: "bg-indigo-400" },
      { name: "Conduite de Travaux", color: "bg-teal-400" },
      { name: "Gestion et Contrôle des Travaux", color: "bg-green-400" },
      { name: "Innovation et Développement Durable", color: "bg-emerald-400" },
