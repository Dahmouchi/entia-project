...
const reviews = [
  {
    ...
    comment: "Je suis embauché par le Groupe VINCI (SOGEA Maroc). L'avantage de suivre la formation à l'ENITA : c'est la souplesse que l'on peut avoir en travaillant et à la fois en suivant les cours.",
  },
  {
    name: "Fatima Z. – Licence BTP",
    comment: "ENITA m'a permis de concilier études et vie professionnelle grâce à la formation à distance. Les diplômes français sont un vrai plus sur le marché.",
  },
 
  {
    name: "Sarah L. – Bac+3 Chargé d'Affaires",
    comment: "Formation très professionnalisante. Les enseignements sont directement applicables en entreprise. Je recommande vivement ENITA pour les métiers du bâtiment.",
  },
    ...
    >
      ...
      >
        ...
        <p className="text-sm md:text-xl text-gray-300 max-w-3xl mx-auto px-2 mt-3 md:mt-4">
          Des entreprises et institutions qui nous font confiance témoignent de leur expérience avec Enita.ma.
        </p>
      </motion.div>
