          ...
          <div className="grid grid-cols-2 gap-1 w-full">
            <Button
              ...
              className={`w-full rounded-l-full py-3 cursor-pointer ${
                isLogin
                  ? "bg-blue-500 hover:bg-green-800 text-white"
            ...
            <Button
              ...
              className={`w-full rounded-r-full py-3 cursor-pointer ${
                !isLogin
                  ? "bg-blue-500 text-white hover:bg-green-800"
          ...
          <Form {...formLogin}>
            ...
            >
              ...
              <div className="w-full flex items-center justify-start">
                <Button
                  type="submit"
                  className="w-full rounded-full py-3 bg-blue-500 border-2 text-white hover:bg-green-700 cursor-pointer"
                >
