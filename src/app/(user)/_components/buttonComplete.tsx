...
const ButtonComplete = (params:any) => {
  ...
  useEffect(() => {
      const fetchCompletionStatus = async () => {
       const res = await getCourseCompletionStatus(params.userId, params.course.id);       
  ...
  return ( 
        <button 
          ...
          className="relative inline-flex h-12 active:scale-95 transition overflow-hidden rounded-lg p-[1px] focus:outline-none disabled:opacity-70 disabled:cursor-not-allowed"
        >
