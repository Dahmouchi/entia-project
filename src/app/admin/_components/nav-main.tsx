                  ...
                  <Link href={item.url}>
                    <SidebarMenuButton
                      ...
                      className={clsx(
                        ...
                        isActive
                          ? "bg-[#c33511] shadow-[4px_6px_7px_0px_rgba(0,_0,_0,_0.1)]  text-white hover:bg-[#c33511] hover:text-white  font-semibold"
                          : "hover:bg-[#c33511]/30 hover:text-[#c33511] dark:hover:bg-gray-800",
                      )}
                    >
                      <div
                        className={`${
                          isActive && state === "expanded"
                            ? "bg-white rounded-md p-1.5 text-[#c33511]"
                            : ""
                        }`}
                      >
                        {" "}
